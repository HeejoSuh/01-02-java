 ...
 *     
 * THIS DOES NOT WORK FOR STRING INPUTS
 * SO
 * NEED
 * TO
 * FIX
    	...
    	while (lengthOfLog!=0.25 && lengthOfLog!=0.5 && lengthOfLog!= 1) {
        	...
        	lengthOfLog = scanner.nextDouble();// Scans input
    			...
    			if (lengthOfLog==0.25 || lengthOfLog==0.5 || lengthOfLog== 1)
    			{
    				...
    				//calculate
    				double numberOfLogsCanCarry= truckCanCarry / ( logWeigh * 
    						lengthOfLog );
...
}//closing for public class LogProgramTry